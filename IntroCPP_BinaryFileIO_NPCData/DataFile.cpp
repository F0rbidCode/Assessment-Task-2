...
{
	//Clear(); //nolonger needed as vector has been removed
}

//old add record function
...
////////////////////////////////////////////////
///////Fined the record start position
////////////////////////////////////////////////
void DataFile :: GetPositions(string filename)
{
	...
	starts.push_back(infile.tellg()); //get the start point of the first record
	...
	for (int i = 0; i < recordCount; i++)
	{
		...
		starts.push_back(infile.tellg()); //get the end point of the current record
